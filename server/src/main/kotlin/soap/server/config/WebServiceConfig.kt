...
class WebServiceConfig : WsConfigurerAdapter() {
    @Bean
    fun messageDispatcherServlet(applicationContext: ApplicationContext) = ServletRegistrationBean(MessageDispatcherServlet().apply {
    ...
    fun defaultWsdl11Definition(countriesSchema: XsdSchema?): DefaultWsdl11Definition {
        ...
        wsdl11Definition.setTargetNamespace("http://product");
